...
public class RockLancherRunner
{
    public static void main(String[] args)
    {
        ...
        world.add(new Location(4, 5), new RockLancherCritter());
        world.add(new RockLancherCritter());
        world.add(new Location(7, 4), new RockLancherCritter());
        world.show();
    }
}